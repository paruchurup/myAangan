...
export const routes: Routes = [
  ...
  // ── Services Directory ──────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      {
        path: 'add',
        loadComponent: () => import('./modules/services/add-provider/add-provider.component').then(m => m.AddProviderComponent)
      },
      {
        path: ':id',
        loadComponent: () => import('./modules/services/provider-detail/provider-detail.component').then(m => m.ProviderDetailComponent)
      }
    ]
  },
  // ── Admin ───────────────────────────────────────────────────────────────────
  {
    ...
    children: [
      {
        path: 'users',
        loadComponent: () => import('./modules/admin/user-list/user-list.component').then(m => m.UserListComponent)
      },
      {
        path: 'pending',
        loadComponent: () => import('./modules/admin/pending-users/pending-users.component').then(m => m.PendingUsersComponent)
      },
      {
        path: 'categories',
